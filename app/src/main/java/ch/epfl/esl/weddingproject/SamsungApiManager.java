...
public class SamsungApiManager {
    ...
    private SCameraProcessorManager processorManager;
    private SCameraProcessor mProcessor;
    private SCameraProcessorParameter parameter;
    ...
    private void createUI() {
        ...
        photoButton = context.findViewById(R.id.photoButton);
        photoButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context, "Picture taken!", Toast.LENGTH_SHORT).show();

                processorManager = mSCamera.getSCameraProcessorManager();
                if (processorManager.isProcessorAvailable(
                        SCameraProcessorManager.PROCESSOR_TYPE_DEPTH_OF_FIELD)) {
                    // This device does support DOF processor

                    mProcessor = processorManager.createProcessor
                            (SCameraProcessorManager.PROCESSOR_TYPE_DEPTH_OF_FIELD);

                    parameter = mProcessor.getParameters();
                    ...
                    parameter.set(SCameraDepthOfFieldProcessor.STILL_SIZE, new Size(640, 480));
